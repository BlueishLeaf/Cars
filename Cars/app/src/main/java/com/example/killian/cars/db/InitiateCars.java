...
public class InitiateCars {
    public static void initCars(SQLiteDatabase db) {
        ...
        db.execSQL("insert into " + DBConstants.DATABASE_TABLE_CARS + "(" + DBConstants.KEY_ID + ","
                ...
                + DBConstants.KEY_DESCRIPTION + ", "
                + DBConstants.KEY_IMAGE_URL + ") "
                + "values(2,'Mazda 323', 'Blue', '240000', 'description', 'https://upload.wikimedia.org/wikipedia/commons/3/36/2015_Audi_R8_Coup%C3%A9_5.2_FSI_quattro_%2819409896583%29.jpg')");
        ...
        db.execSQL("insert into " + DBConstants.DATABASE_TABLE_CARS + "(" + DBConstants.KEY_ID + ","
                ...
                + DBConstants.KEY_DESCRIPTION + ", "
                + DBConstants.KEY_IMAGE_URL + ") "
                + "values(3,'Mazda 323', 'Blue', '240000', 'description', 'https://upload.wikimedia.org/wikipedia/commons/3/36/2015_Audi_R8_Coup%C3%A9_5.2_FSI_quattro_%2819409896583%29.jpg')");
    }
